...
/// Root component: wires global providers and hands every path over to the
/// typed router — the counterpart of `RouterProvider` in the TypeScript admin's
/// `app.tsx`. Theme, query client and auth providers belong here.
#[component]
pub fn App() -> Element {
