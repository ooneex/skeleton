...
pub struct EnglishFlagProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

/// UK / English flag icon (48 × 48).
#[component]
pub fn EnglishFlag(props: EnglishFlagProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                ...
                path {
                    d: "M18.006,20,.615,6.562A1.989,1.989,0,0,0,0,8v.3L15.144,20Z",
                    fill: "#d10d24",
                }
                path {
