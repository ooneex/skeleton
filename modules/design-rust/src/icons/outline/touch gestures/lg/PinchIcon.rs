...
pub struct PinchIconProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

#[component]
pub fn PinchIcon(props: PinchIconProps) -> Element {
    rsx! {
        svg {
            height: "16",
            width: "16",
            ...
            ..props.attributes,
            path {
                d: "M1.99994 10.9999L8.99988 10.9999L8.99982 17.9966",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M17.9999 8.99835L11 8.99835L11.0001 2.00165",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
