...
pub fn CircleInfoSparkleIcon(props: CircleInfoSparkleIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M29 3.59889C27.3976 3.20751 25.723 3 24 3C12.402 3 3 12.402 3 24C3 35.598 12.402 45 24 45C35.598 45 45 35.598 45 24C45 22.277 44.7925 20.6024 44.4011 19",
                stroke: "currentColor",
                stroke_width: "2",
