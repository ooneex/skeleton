...
pub fn InputPasswordSettingsIcon(props: InputPasswordSettingsIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M30 12.5V9C30 7.34315 28.6569 6 27 6H5C3.34315 6 2 7.34315 2 9V19C2 20.6569 3.34315 22 5 22H13",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M27.536 17.05L28.596 16.697L29.303 17.404L28.95 18.464",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                "data-color": "color-2",
            ...
            path {
                d: "M28.95 25.536L29.303 26.596L28.596 27.303L27.536 26.95",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                "data-color": "color-2",
            ...
            path {
                d: "M20.464 26.95L19.404 27.303L18.697 26.596L19.05 25.536",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                "data-color": "color-2",
            ...
            path {
                d: "M19.05 18.464L18.697 17.404L19.404 16.697L20.464 17.05",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                "data-color": "color-2",
