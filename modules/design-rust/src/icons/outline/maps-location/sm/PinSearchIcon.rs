...
pub fn PinSearchIcon(props: PinSearchIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M12 22C12 22 4.5 15.5 4.5 9.75768C4.5 4.81181 8.34409 2 12 2C15.6559 2 19.5 4.81181 19.5 9.75768C19.5 9.93684 19.4927 10.1167 19.4786 10.2972",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M22.5 22.5001L19.975 19.9751",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
