...
pub fn Camera2Icon(props: Camera2IconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M9.5 4.5L9.5 4C9.5 3.72386 9.27614 3.5 9 3.5L7 3.5C6.72386 3.5 6.5 3.72386 6.5 4L6.5 4.5",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M19 22C22.3137 22 25 19.3137 25 16C25 12.6863 22.3137 10 19 10C15.6863 10 13 12.6863 13 16C13 19.3137 15.6863 22 19 22Z",
                stroke: "currentColor",
                stroke_width: "2",
