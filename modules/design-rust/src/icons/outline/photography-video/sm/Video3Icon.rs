...
pub fn Video3Icon(props: Video3IconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M15 10H5C3.89543 10 3 10.8954 3 12V18C3 19.1046 3.89543 20 5 20H15C16.1046 20 17 19.1046 17 18V12C17 10.8954 16.1046 10 15 10Z",
                stroke: "currentColor",
                stroke_width: "2",
