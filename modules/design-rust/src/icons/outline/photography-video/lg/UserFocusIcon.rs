...
pub fn UserFocusIcon(props: UserFocusIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M24 21C26.7614 21 29 18.7614 29 16C29 13.2386 26.7614 11 24 11C21.2386 11 19 13.2386 19 16C19 18.7614 21.2386 21 24 21Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M24 25C17.373 25 12 29.7761 12 35.667C19.9995 37.4443 28.0005 37.4443 36 35.667C36 29.7761 30.627 25 24 25Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
