...
pub fn CarCharging2Icon(props: CarCharging2IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M36 34V36C36 37.1046 36.8954 38 38 38H43C44.1046 38 45 37.1046 45 36V23.0838C45 21.0007 43.7086 19.136 41.7587 18.4033L40 17.7424L37.8166 9.9241C37.3339 8.19546 35.7588 7 33.964 7H14.036C12.2412 7 10.6661 8.19546 10.1834 9.9241L8 17.7424L6.24127 18.4033C4.29138 19.136 3 21.0007 3 23.0838V36C3 37.1046 3.89543 38 5 38H10C11.1046 38 12 37.1046 12 36V34",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                fill: "none",
            ...
            path {
                d: "M18 34L18 37C18 40.3137 20.6863 43 24 43C27.3137 43 30 40.3137 30 37L30 34L18 34Z",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M24 12L21.5 17H24H26.5L24 22",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
