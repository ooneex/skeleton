...
pub fn CartSimpleAddIcon(props: CartSimpleAddIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M4.821 6H22L21.4 9M1 2H4L5.75469 14.2828C5.89545 15.2681 6.73929 16 7.73459 16H12.3556",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M14.0001 22C14.4549 19.9962 15.8587 18.5 18 18.5C20.1413 18.5 21.5452 19.9962 22.0001 22H14.0001Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
