...
pub fn BasketAlertIcon(props: BasketAlertIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M24 31C24.6904 31 25.25 30.4404 25.25 29.75C25.25 29.0596 24.6904 28.5 24 28.5C23.3096 28.5 22.75 29.0596 22.75 29.75C22.75 30.4404 23.3096 31 24 31Z",
                fill: "currentColor",
                "data-color": "color-2",
                "data-cap": "butt",
                "data-stroke": "none",
