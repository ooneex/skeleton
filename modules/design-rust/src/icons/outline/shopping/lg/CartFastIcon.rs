...
pub fn CartFastIcon(props: CartFastIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M41 32H9.72862C7.41114 32 6.34098 29.1197 8.09624 27.6065L10.6923 25.3684L9.92615 20H2",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M3 3H4.89811C6.39106 3 7.65683 4.09779 7.86796 5.57573L8.5 10H40.0001L37.4016 21.1361C36.8736 23.3991 34.8562 25 32.5324 25H10.5H11.5",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
