...
pub fn CartArrowDownIcon(props: CartArrowDownIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M8.5 10H14M10.5 25H32.7799C34.9879 25 36.9346 23.5517 37.569 21.4367L41.0001 10H35",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M41 32H9.34255C7.0735 32 5.97795 29.2206 7.63676 27.6724L10.5 25L7.79484 5.16225C7.62593 3.92355 6.56797 3.00005 5.3178 3.00003L3 3",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
