...
pub fn FaceSadCryingIcon(props: FaceSadCryingIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M32 26C33.8178 27.5 35.5 29.75 35.5 31.6827C35.5 33.7218 33.9329 35 32 35C30.0671 35 28.5 33.7218 28.5 31.6827C28.5 29.75 30.2008 27.5 32 26Z",
                fill: "currentColor",
                "data-cap": "butt",
                "data-stroke": "none",
            }
            ...
            path {
                d: "M13.1814 35C14.1219 29.8798 18.6079 26 24 26C24.8599 26 25.6968 26.0987 26.5 26.2853",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
