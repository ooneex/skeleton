...
pub fn BankingMobileIcon(props: BankingMobileIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M18.6667 13L14.75 13C13.2312 13 12 14.2312 12 15.75V15.75C12 17.2688 13.2312 18.5 14.75 18.5H17.25C18.7688 18.5 20 19.7312 20 21.25V21.25C20 22.7688 18.7688 24 17.25 24H13.3333",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
