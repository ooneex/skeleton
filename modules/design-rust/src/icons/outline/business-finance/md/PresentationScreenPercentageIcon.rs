...
pub fn PresentationScreenPercentageIcon(props: PresentationScreenPercentageIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15 9C15 7.89543 14.1046 7 13 7C11.8954 7 11 7.89543 11 9C11 10.1046 11.8954 11 13 11C14.1046 11 15 10.1046 15 9Z",
                fill: "currentColor",
                "data-color": "color-2",
                "data-stroke": "none",
                "data-cap": "butt",
            ...
            path {
                d: "M21 15C21 13.8954 20.1046 13 19 13C17.8954 13 17 13.8954 17 15C17 16.1046 17.8954 17 19 17C20.1046 17 21 16.1046 21 15Z",
                fill: "currentColor",
                "data-color": "color-2",
                "data-stroke": "none",
                "data-cap": "butt",
