...
pub fn MobileCreditCardIcon(props: MobileCreditCardIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M30 27L30 19C30 17.8954 29.1046 17 28 17L16 17C14.8954 17 14 17.8954 14 19L14 27C14 28.1046 14.8954 29 16 29L28 29C29.1046 29 30 28.1046 30 27Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M25 13L25 5C25 3.34315 23.6569 2 22 2L10 2C8.34315 2 7 3.34315 7 5L7 27C7 28.6569 8.34315 30 10 30L10.094 30",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
