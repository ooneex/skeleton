...
pub fn CoinsPercentageIcon(props: CoinsPercentageIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M36 5C36 3.34315 34.6569 2 33 2C31.3431 2 30 3.34315 30 5C30 6.65685 31.3431 8 33 8C34.6569 8 36 6.65685 36 5Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M46 15C46 13.3431 44.6569 12 43 12C41.3431 12 40 13.3431 40 15C40 16.6569 41.3431 18 43 18C44.6569 18 46 16.6569 46 15Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
