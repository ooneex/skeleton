...
pub fn ClipboardCoinArrowUpIcon(props: ClipboardCoinArrowUpIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M7.5 30.5H16C20.4183 30.5 24 26.9183 24 22.5V21",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M16 5H12C9.23858 5 7 7.23858 7 10V40C7 42.7614 9.23858 45 12 45H21M32 5H36C38.7614 5 41 7.23858 41 10V24.5",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
