...
pub fn SportsTshirtIcon(props: SportsTshirtIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M13.5 15.5C13.5 16.8807 14.6193 18 16 18C17.3807 18 18.5 16.8807 18.5 15.5C18.5 14.1193 17.3807 13 16 13C14.6193 13 13.5 14.1193 13.5 15.5Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
            ...
            path {
                d: "M16 24C14.3431 24 13 22.6569 13 21C13 19.3431 14.3431 18 16 18C17.6569 18 19 19.3431 19 21C19 22.6569 17.6569 24 16 24Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
