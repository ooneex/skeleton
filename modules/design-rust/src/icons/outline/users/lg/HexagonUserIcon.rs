...
pub fn HexagonUserIcon(props: HexagonUserIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M35.6725 38.8958C33.0319 35.3195 28.7869 33 24.0001 33C19.2133 33 14.9683 35.3195 12.3276 38.8959",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M24 2.5L43 13.25V34.75L24 45.5L5 34.75V13.25L24 2.5Z",
                stroke: "currentColor",
                stroke_width: "2",
                fill: "none",
                "data-cap": "butt",
