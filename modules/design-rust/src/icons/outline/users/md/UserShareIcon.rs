...
pub fn UserShareIcon(props: UserShareIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M17 16.0396C16.6703 16.0134 16.3368 16 16 16C9.373 16 4 21.1741 4 27.5559C7.99975 28.5186 11.9999 29 16 29",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M28 20C29.1046 20 30 19.1046 30 18C30 16.8954 29.1046 16 28 16C26.8954 16 26 16.8954 26 18C26 19.1046 26.8954 20 28 20Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
