...
pub fn UsersHeartIcon(props: UsersHeartIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "m12,9.5c1.109-.5,5-3.271,5-5.811,0-1.485-1.206-2.689-2.692-2.689-.98,0-1.712.614-2.308,1.303-.595-.69-1.328-1.303-2.308-1.303-1.487,0-2.692,1.204-2.692,2.689,0,2.54,3.891,5.311,5,5.811Z",
                fill: "none",
                stroke: "currentColor",
