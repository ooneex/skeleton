...
pub fn FileBmpIcon(props: FileBmpIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M24 29V20H27C28.6569 20 30 21.3431 30 23V23C30 24.6569 28.6569 26 27 26H24.6",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
            ...
            path {
                d: "M2 29V20H4.75C5.99264 20 7 21.0074 7 22.25C7 23.4926 5.99264 24.5 4.75 24.5H2.64282H6.25C7.49264 24.5 8.5 25.5074 8.5 26.75C8.5 27.9926 7.49264 29 6.25 29H2Z",
                stroke: "currentColor",
                stroke_width: "2",
                "data-color": "color-2",
                "data-cap": "butt",
