...
pub fn SteeringWheelIcon(props: SteeringWheelIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M8.5 20.5V20.5C17.9366 14.4119 30.0634 14.4119 39.5 20.5V20.5",
                stroke: "currentColor",
                stroke_width: "2",
                "data-color": "color-2",
                "data-cap": "butt",
            ...
            path {
                d: "M40 25L32.3805 27.7707C30.2995 28.5275 28.8044 30.3689 28.4913 32.5609L27.5 39.5",
                stroke: "currentColor",
                stroke_width: "2",
                "data-color": "color-2",
                "data-cap": "butt",
            ...
            path {
                d: "M8 25L15.6195 27.7707C17.7005 28.5275 19.1956 30.3689 19.5087 32.5609L20.5 39.5",
                stroke: "currentColor",
                stroke_width: "2",
                "data-color": "color-2",
                "data-cap": "butt",
