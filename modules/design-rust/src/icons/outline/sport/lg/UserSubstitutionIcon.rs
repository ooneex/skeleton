...
pub fn UserSubstitutionIcon(props: UserSubstitutionIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M26 24.1031C25.3433 24.035 24.676 24 24 24C14.0595 24 6 31.5622 6 40.8894C11.9996 42.2965 17.9998 43 24 43C25.6667 43 27.3333 42.9457 29 42.8372",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
