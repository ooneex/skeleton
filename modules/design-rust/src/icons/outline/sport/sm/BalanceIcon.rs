...
pub fn BalanceIcon(props: BalanceIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M10.0078 22L10.1122 7.99998H10.5078",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
            ...
            path {
                d: "M13.5616 8H14.0616L15 14L17.3043 15.1521C18.0235 15.5118 18.0457 16.5302 17.3427 16.9207L14.5 18.5",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
