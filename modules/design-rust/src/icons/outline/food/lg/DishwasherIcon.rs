...
pub fn DishwasherIcon(props: DishwasherIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M43 17L31 17L30.2764 15.5528C30.107 15.214 29.7607 15 29.382 15L18.618 15C18.2393 15 17.893 15.214 17.7236 15.5528L17 17L5 17",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M11 23H19V27C19 29.2091 17.2091 31 15 31C12.7909 31 11 29.2091 11 27V23Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
