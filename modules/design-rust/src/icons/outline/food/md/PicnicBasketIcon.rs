...
pub fn PicnicBasketIcon(props: PicnicBasketIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M12 17H2V15C2 13.3431 3.34315 12 5 12H14",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M20 17H30V15C30 13.3431 28.6569 12 27 12H18",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M14 4V15H18V4C18 2.89543 17.1046 2 16 2C14.8954 2 14 2.89543 14 4Z",
                stroke: "currentColor",
                stroke_width: "2",
                "data-color": "color-2",
                "data-cap": "butt",
