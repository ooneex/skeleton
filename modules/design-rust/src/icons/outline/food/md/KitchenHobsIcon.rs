...
pub fn KitchenHobsIcon(props: KitchenHobsIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M21 23C22.6569 23 24 21.6569 24 20C24 18.3431 22.6569 17 21 17C19.3431 17 18 18.3431 18 20C18 21.6569 19.3431 23 21 23Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                "data-color": "color-2",
            ...
            path {
                d: "M11 23C12.6569 23 14 21.6569 14 20C14 18.3431 12.6569 17 11 17C9.34315 17 8 18.3431 8 20C8 21.6569 9.34315 23 11 23Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                "data-color": "color-2",
