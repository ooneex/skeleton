...
pub fn CrumpetIcon(props: CrumpetIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M6.25 13.5C6.94036 13.5 7.5 12.9404 7.5 12.25C7.5 11.5596 6.94036 11 6.25 11C5.55964 11 5 11.5596 5 12.25C5 12.9404 5.55964 13.5 6.25 13.5Z",
                fill: "currentColor",
                "data-color": "color-2",
                "data-cap": "butt",
                "data-stroke": "none",
            ...
            path {
                d: "M12.25 8.5C12.9404 8.5 13.5 7.94036 13.5 7.25C13.5 6.55964 12.9404 6 12.25 6C11.5596 6 11 6.55964 11 7.25C11 7.94036 11.5596 8.5 12.25 8.5Z",
                fill: "currentColor",
                "data-color": "color-2",
                "data-cap": "butt",
                "data-stroke": "none",
