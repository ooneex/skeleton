...
pub fn SnowmanIcon(props: SnowmanIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M44.5 20L41 18.5L41.5 18.7143",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
            ...
            path {
                d: "M30.0635 9C30.6591 9.98058 31 11.119 31 12.3333C31 16.0152 27.866 19 24 19C20.134 19 17 16.0152 17 12.3333C17 11.119 17.3409 9.98058 17.9365 9",
                stroke: "currentColor",
                stroke_width: "2",
                "data-cap": "butt",
                fill: "none",
            ...
            path {
                d: "M45 15L35 24L35.2903 23.7387",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
            ...
            path {
                d: "M38 32C38 39.1797 31.732 45 24 45C16.268 45 10 39.1797 10 32C10 24.8203 16.268 19 24 19C31.732 19 38 24.8203 38 32Z",
                stroke: "currentColor",
                stroke_width: "2",
                "data-cap": "butt",
                fill: "none",
