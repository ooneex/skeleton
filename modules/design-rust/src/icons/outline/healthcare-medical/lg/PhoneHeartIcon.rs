...
pub fn PhoneHeartIcon(props: PhoneHeartIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M24 34C25.7744 33.1765 32 28.6125 32 24.4289C32 21.9831 30.0704 20 27.6928 20C26.1248 20 24.9536 21.0113 24 22.1461C23.048 21.0096 21.8752 20 20.3072 20C17.928 20 16 21.9831 16 24.4289C16 28.6125 22.2256 33.1765 24 34Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
