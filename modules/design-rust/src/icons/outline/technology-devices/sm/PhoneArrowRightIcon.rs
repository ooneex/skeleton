...
pub fn PhoneArrowRightIcon(props: PhoneArrowRightIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M5.00001 10L5.00001 4C5.00001 2.89543 5.89544 2 7.00001 2L17 2C18.1046 2 19 2.89543 19 4L19 20C19 21.1046 18.1046 22 17 22L7 22C5.89543 22 5 21.1046 5 20L5 18",
                stroke: "currentColor",
                stroke_width: "2",
