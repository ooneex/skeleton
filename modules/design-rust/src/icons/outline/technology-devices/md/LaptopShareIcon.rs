...
pub fn LaptopShareIcon(props: LaptopShareIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M4 19V7C4 5.34315 5.34315 4 7 4H22",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M28 18C29.1046 18 30 17.1046 30 16C30 14.8954 29.1046 14 28 14C26.8954 14 26 14.8954 26 16C26 17.1046 26.8954 18 28 18Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
