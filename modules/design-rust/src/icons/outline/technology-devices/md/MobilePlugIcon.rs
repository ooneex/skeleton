...
pub fn MobilePlugIcon(props: MobilePlugIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M16 30L10 30C8.34315 30 7 28.6569 7 27L7 5C7 3.34315 8.34315 2 10 2L22 2C23.6569 2 25 3.34315 25 5L25 12",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M17 20L17 23C17 25.7614 19.2386 28 22 28C24.7614 28 27 25.7614 27 23L27 20L17 20Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
