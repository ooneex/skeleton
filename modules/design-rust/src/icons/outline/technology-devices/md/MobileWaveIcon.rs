...
pub fn MobileWaveIcon(props: MobileWaveIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M4 18H7.99998C9.65684 18 11 16.6569 11 15V13.5C11 12.1193 12.1193 11 13.5 11V11C14.8807 11 16 12.1193 16 13.5V22.5C16 23.8807 17.1193 25 18.5 25V25C19.8807 25 21 23.8807 21 22.5V21C21 19.3431 22.3431 18 24 18H28",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
