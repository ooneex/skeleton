...
pub fn MobileDockIcon(props: MobileDockIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M24 19L29 19L29 26C29 27.6569 27.6568 29 26 29L6 29C4.34314 29 3 27.6569 3 26L3 19L8 19",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M21 2L11 2C9.34315 2 8 3.34315 8 5L8 22C8 23.6569 9.34315 25 11 25L21 25C22.6569 25 24 23.6569 24 22L24 5C24 3.34315 22.6569 2 21 2Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
