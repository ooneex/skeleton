...
pub fn MobileCodeIcon(props: MobileCodeIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M30 28.0002L37.9998 36L29.9998 44",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M17.9997 28.0002L9.99988 36L17.9999 44",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M11 23L11 8C11 5.23858 13.2386 3 16 3L32 3C34.7614 3 37 5.23858 37 8L37 23",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
