...
pub fn UserLaptopIcon(props: UserLaptopIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M21.5 43H38.2391L44.5 31H27.7609L21.5 43Z",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M10 41.7232C8.66664 41.48 7.33331 41.2021 6 40.8894C6 31.5622 14.0595 24 24 24C27.0741 24 29.9684 24.7232 32.5 25.9982",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
