...
pub fn LaptopAppsIcon(props: LaptopAppsIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M4 19V7C4 5.34315 5.34315 4 7 4H11",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
            ...
            path {
                d: "M26.5 9C27.8807 9 29 7.88071 29 6.5C29 5.11929 27.8807 4 26.5 4C25.1193 4 24 5.11929 24 6.5C24 7.88071 25.1193 9 26.5 9Z",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_miterlimit: "10",
                stroke_linecap: "square",
