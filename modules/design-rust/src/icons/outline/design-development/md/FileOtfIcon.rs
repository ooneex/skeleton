...
pub fn FileOtfIcon(props: FileOtfIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M23.5 29L23.5 20H28.5M27.25 24.5H24.125",
                stroke: "currentColor",
                stroke_width: "2",
            ...
            path {
                d: "M16.5 29V20M16.5 20H19.5M16.5 20L13.5 20",
                stroke: "currentColor",
                stroke_width: "2",
                stroke_linecap: "square",
                "data-color": "color-2",
            ...
            path {
                d: "M11 24.5C11 26.9853 9.20914 29 7 29C4.79086 29 3 26.9853 3 24.5C3 22.0147 4.79086 20 7 20C9.20914 20 11 22.0147 11 24.5Z",
                stroke: "currentColor",
                stroke_width: "2",
                "data-color": "color-2",
                "data-cap": "butt",
