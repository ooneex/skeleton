    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M2 6C2 4.89543 2.89543 4 4 4H20C21.1046 4 22 4.89543 22 6V13H2V6ZM5 7H12V9H5V7ZM19 7H14V9H19V7Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
