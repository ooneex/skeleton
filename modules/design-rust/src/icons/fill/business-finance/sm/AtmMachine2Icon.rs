    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M7 4H14V24H7C5.34315 24 4 22.6569 4 21V7C4 5.34315 5.34315 4 7 4ZM10 8H8L8 12H10V8Z",
                fill: "currentColor",
            }
            path {
                d: "M17 24V4C18.6569 4 20 5.34315 20 7L20 21C20 22.6569 18.6569 24 17 24Z",
                fill: "currentColor",
            }
        }
    }
