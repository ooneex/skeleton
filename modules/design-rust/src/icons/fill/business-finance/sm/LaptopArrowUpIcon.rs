...
pub struct LaptopArrowUpIconProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

#[component]
pub fn LaptopArrowUpIcon(props: LaptopArrowUpIconProps) -> Element {
    rsx! {
        svg {
            height: "16",
            width: "16",
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M11 9H13L12.9753 10.5C12.7245 13.0267 10.5927 15 8 15H2V13H8C9.65685 13 11 11.6569 11 10V9Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M12 5.33332L15.5 9.99999L8.49999 9.99999L12 5.33332Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
