    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M6.12602 6C6.04375 6.31962 6 6.6547 6 7V24C6 26.2091 7.79086 28 10 28H18V6H6.12602ZM11 8H13V13H11V8Z",
                fill: "currentColor",
            }
            path {
                d: "M22 6V28C24.2091 28 26 26.2091 26 24V7C26 6.6547 25.9562 6.31962 25.874 6H22Z",
                fill: "currentColor",
            }
        }
    }
