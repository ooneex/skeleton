...
pub struct FocusIconProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

#[component]
pub fn FocusIcon(props: FocusIconProps) -> Element {
    rsx! {
        svg {
            height: "16",
            width: "16",
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M13 24C13 17.9249 17.9249 13 24 13C30.0751 13 35 17.9249 35 24C35 30.0751 30.0751 35 24 35C17.9249 35 13 30.0751 13 24Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
