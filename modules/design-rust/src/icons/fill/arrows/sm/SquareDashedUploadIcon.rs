...
pub struct SquareDashedUploadIconProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

#[component]
pub fn SquareDashedUploadIcon(props: SquareDashedUploadIconProps) -> Element {
    rsx! {
        svg {
            height: "16",
            width: "16",
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M11 18L11 7.00004L13 6.99999L13 8.19237L13 18L11 18Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M16.2428 12.6568L12.0001 8.41419L7.75749 12.6568L6.34327 11.2426L12.0001 5.58576L17.657 11.2426L16.2428 12.6568Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
