    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M5 15L27 15L27 17L5 17L5 15Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M19 6.49985L13 6.5L16 2.5L19 6.49985Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
            ...
            path {
                d: "M19 25.5001L13 25.5L16 29.5L19 25.5001Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M11 24.5L16.0001 31.1667L21 24.5002L11 24.5Z",
                fill: "currentColor",
            }
            path {
                d: "M25.5001 19L25.5 13L29.5 16L25.5001 19Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
            ...
            path {
                d: "M6.49985 19L6.5 13L2.5 16L6.49985 19Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
