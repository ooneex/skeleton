    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M15.5 4.5V43.5H12.5V4.5H15.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M35.5 4.5V43.5H32.5V4.5H35.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M25.5 4.5V43.5H22.5V4.5H25.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M43.5 15.5L4.5 15.5L4.5 12.5L43.5 12.5L43.5 15.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M43.5 35.5L4.5 35.5L4.5 32.5L43.5 32.5L43.5 35.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M43.5 25.5L4.5 25.5L4.5 22.5L43.5 22.5L43.5 25.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
