...
pub fn WeightliftingIcon(props: WeightliftingIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M3 11L1 11L1 1L3 1L3 11Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M21 11L23 11L23 1L21 1L21 11Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M15.664 22L16.3642 15L7.6518 15L8.3061 22L15.664 22Z",
                fill: "currentColor",
            }
            path {
            ...
            path {
                d: "M16.1592 17H7.84082L4.41211 9H6.58789L9.15918 15H14.8408L17.4121 9H19.5879L16.1592 17Z",
                fill: "currentColor",
            }
        }
    }
