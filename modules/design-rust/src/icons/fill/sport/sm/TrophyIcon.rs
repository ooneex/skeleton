...
pub fn TrophyIcon(props: TrophyIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M13 17V21H11V17H13Z",
                fill: "currentColor",
            }
            path {
                d: "M19 8C19 11.866 15.866 15 12 15C8.13401 15 5 11.866 5 8V2H19V8Z",
                fill: "currentColor",
            }
            path {
                d: "M17 23H7C7 20.7909 8.79086 19 11 19H13C15.2091 19 17 20.7909 17 23Z",
                fill: "currentColor",
            }
        }
    }
