...
pub fn TrophyIcon(props: TrophyIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M17 20.0001V25.0001H15V20.0001H17Z",
                fill: "currentColor",
            }
            path {
                d: "M26 11C26 16.5228 21.5228 21 16 21C10.4772 21 6 16.5228 6 11V2H26V11Z",
                fill: "currentColor",
            }
            path {
                d: "M23 30H9V28C9 25.7909 10.7909 24 13 24H19C21.2091 24 23 25.7909 23 28V30Z",
                fill: "currentColor",
            }
        }
    }
