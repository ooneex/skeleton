...
pub fn ShovelPitchforkIcon(props: ShovelPitchforkIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M19 21H17V13H19V21Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M7 21L5 21L5 13L7 13L7 21Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M19 12L17 12L17 2.5L19 2.5L19 12Z",
                fill: "currentColor",
            }
            path {
            ...
            path {
                d: "M6 2C8.76142 2 11 4.23858 11 7V13H7V9H5V13H1V7C1 4.23858 3.23858 2 6 2Z",
                fill: "currentColor",
            }
        }
    }
