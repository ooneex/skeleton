    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M21 11H3V21H6V19H18V21H21V11ZM8.01 14H4V16H6.01C7.11457 16 8.01 15.1046 8.01 14ZM16 14H20.01V16H18C16.8954 16 16 15.1046 16 14Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
