...
pub fn RotateCubeIcon(props: RotateCubeIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M16.8717 8.46622L12 6.41498L7.1283 8.46622L12 10.5959L16.8717 8.46622Z",
                fill: "currentColor",
            }
            path {
                d: "M17.5 10.3743L13 12.3415V17.164L17.5 15.2693V10.3743Z",
                fill: "currentColor",
            }
            path {
                d: "M11 17.164V12.3415L6.5 10.3743V15.2693L11 17.164Z",
                fill: "currentColor",
            }
        }
    }
