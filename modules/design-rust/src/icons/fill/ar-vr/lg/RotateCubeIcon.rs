...
pub fn RotateCubeIcon(props: RotateCubeIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M35.0523 16.2726L24 11.4075L12.9478 16.2726L24 21.3492L35.0523 16.2726Z",
                fill: "currentColor",
            }
            path {
                d: "M36 19.1387L25.5 23.9616V35.9324L36 31.3104V19.1387Z",
                fill: "currentColor",
            }
            path {
                d: "M22.5 35.9324V23.9616L12 19.1387V31.3104L22.5 35.9324Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
