    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M4 18H14V20.1084L6.63455 28H14V30H4V27.8916L11.3654 20H4V18Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M7.30701 2H10.193L14.693 14H12.1V12.7813L8.80701 4H8.69301L5.40001 12.7813V14H2.80701L7.30701 2Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M12.5 11H5V9H12.5V11Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
