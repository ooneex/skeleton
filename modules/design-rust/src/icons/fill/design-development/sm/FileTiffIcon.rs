    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M0.5 14H6.5V16H4.5V22H2.5V16H0.5V14Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M17.5 14H23V16H19.5V17.5H22V19.5H19.5V22H17.5V14Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M11 14H16.5V16H13V17.5H15.5V19.5H13V22H11V14Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
