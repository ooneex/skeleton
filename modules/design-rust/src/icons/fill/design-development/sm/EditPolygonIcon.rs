    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M8 3.5H16V5.5H8V3.5Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M5 18.5H19V20.5H5V18.5Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
            ...
            path {
                d: "M14.5 1.5H20.5V7.5H14.5V1.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M17.5 16.5H23.5V22.5H17.5V16.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M3.5 1.5H9.5V7.5H3.5V1.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M0.5 16.5H6.5V22.5H0.5V16.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
