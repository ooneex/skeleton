...
pub fn SquareCommandIcon(props: SquareCommandIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "m8,7c-.552,0-1,.449-1,1s.448,1,1,1h1v-1c0-.551-.448-1-1-1Z",
                stroke_width: "0",
                fill: "currentColor",
            }
            path {
                d: "m16,17c.552,0,1-.449,1-1s-.448-1-1-1h-1v1c0,.551.448,1,1,1Z",
                stroke_width: "0",
                fill: "currentColor",
            }
            path {
                d: "m17,8c0-.551-.448-1-1-1s-1,.449-1,1v1h1c.552,0,1-.449,1-1Z",
                stroke_width: "0",
                fill: "currentColor",
            }
            path {
                d: "m7,16c0,.551.448,1,1,1s1-.449,1-1v-1h-1c-.552,0-1,.449-1,1Z",
                stroke_width: "0",
                fill: "currentColor",
            }
            rect {
