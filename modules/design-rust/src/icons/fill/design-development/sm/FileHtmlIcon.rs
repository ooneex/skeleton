    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M6 14H11V16H9.5V22H7.5V16H6V14Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M2 14V17H3.5V14H5.5V22H3.5V19H2V22H0V14H2Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M11.5 14H14.1594L15 15.9614L15.8406 14H18.5V22H16.5V17.5386L15 21.0386L13.5 17.5386V22H11.5V14Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M19.5 22H24V20H21.5V14H19.5V22Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
