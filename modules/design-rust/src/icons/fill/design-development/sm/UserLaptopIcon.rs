...
pub fn UserLaptopIcon(props: UserLaptopIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M23.5 15H13L10.375 21H7V23H20L23.5 15Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M2 21C2 16.038 6.038 12 11 12C11.3379 12 11.6716 12.0187 12 12.0552L9.06697 19H7C5.89543 19 5 19.8954 5 21V22.4534C4.25118 22.3178 3.50338 22.1567 2.757 21.97L2 21.781V21Z",
                fill: "currentColor",
            }
            path {
