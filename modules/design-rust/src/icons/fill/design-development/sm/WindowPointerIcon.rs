...
pub fn WindowPointerIcon(props: WindowPointerIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M23 6C23 4.34315 21.6569 3 20 3H4C2.34315 3 1 4.34315 1 6V11.6331H1.65398L3 10.5403L3 9H21V18C21 18.5523 20.5523 19 20 19H12.4732L11.9205 21H20C21.6569 21 23 19.6569 23 18V6Z",
                fill: "currentColor",
            }
        }
    }
