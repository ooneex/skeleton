    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M13 1V5.5H11V1H13Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M12 3.40454L3.05884 7.40454L12 11.4045L20.9412 7.40454L12 3.40454Z",
                fill: "currentColor",
            }
            path {
                d: "M11 13.148L3 9.56909V18.5691L11 22.148V13.148Z",
                fill: "currentColor",
            }
            path {
                d: "M13 13.148V22.148L21 18.5691V9.56909L13 13.148Z",
                fill: "currentColor",
            }
        }
    }
