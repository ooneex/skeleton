    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M8.5 19H15.5V21H13V29H11V21H8.5V19Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M3 19V23H6V19H8V29H6V25H3V29H1V19H3Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M16 19H18.4384L20.5 22.4033L22.5616 19H25V29H23V22.1364L20.5 26.2634L18 22.1364V29H16V19Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
