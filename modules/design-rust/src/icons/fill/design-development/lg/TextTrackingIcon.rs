    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M38 21.5H28V18.5H38V21.5Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M31.4683 6H34.5304L42.9866 28H39V25.9899L33.0015 10.384L27 26.0506V28H23.0406L31.4683 6Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M13.4683 28H16.5459L24.6512 6H20.6969V8.05507L14.9824 23.566L9 7.94941V6H5.04063L13.4683 28Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
