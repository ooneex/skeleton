    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M24.5 40.5H16.5V37.5H20.5H24.5V40.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M22.3655 28.0001H18.6374L13.2527 44.0001H17.0009V42.2682L20.5 31.8709L24.0014 42.305V44.0001H27.7346L22.3655 28.0001Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
