...
pub struct RingIconProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

#[component]
pub fn RingIcon(props: RingIconProps) -> Element {
    rsx! {
        svg {
            height: "16",
            width: "16",
            ...
            ..props.attributes,
            path {
                d: "M35 9.5L28.1895 16.2246L24 15L19.8105 16.2246L13 9.5H35Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
            ...
            path {
                d: "M22.5723 6.5H13.1504L18.582 1H19.8223L22.5723 6.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M34.8496 6.5H25.9277L23.1777 1H29.418L34.8496 6.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
