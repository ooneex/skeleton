...
pub fn TrafficLightIcon(props: TrafficLightIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M41 31V33C41 35.2208 39.7934 37.1599 38 38.1973V31H41Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M7 31V33C7 35.2208 8.2066 37.1599 10 38.1973V31H7Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M41 20V22C41 24.2208 39.7934 26.1599 38 27.1973V20H41Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M7 20V22C7 24.2208 8.2066 26.1599 10 27.1973V20H7Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M41 9V11C41 13.2208 39.7934 15.1599 38 16.1973V9H41Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M7 9V11C7 13.2208 8.2066 15.1599 10 16.1973V9H7Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
