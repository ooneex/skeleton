...
pub fn ScooterParkingIcon(props: ScooterParkingIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M2 1H5.97461L6.18164 1.00488C8.30743 1.11334 9.99292 2.88133 9.97461 5.03418C9.95585 7.22981 8.17031 8.99987 5.97461 9H4V12H2V1ZM4 7H5.97461C7.07243 6.99987 7.96527 6.11441 7.97461 5.0166C7.98326 3.97494 7.19397 3.11416 6.17969 3.01074L5.97461 3H4V7Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
