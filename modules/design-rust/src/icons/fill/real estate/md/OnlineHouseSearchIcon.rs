...
pub fn OnlineHouseSearchIcon(props: OnlineHouseSearchIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M3 7C3 4.79086 4.79086 3 7 3H14V5H7C5.89543 5 5 5.89543 5 7V21H3V7Z",
                fill: "currentColor",
            }
            path {
                d: "M30 6.42578V14.5C30 15.8807 28.8807 17 27.5 17H25V11H21V17H18.5C17.1193 17 16 15.8807 16 14.5V6.42578L23 2.34277L30 6.42578Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
