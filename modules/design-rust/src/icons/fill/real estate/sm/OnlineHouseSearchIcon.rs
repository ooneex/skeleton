...
pub fn OnlineHouseSearchIcon(props: OnlineHouseSearchIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M2 5C2 3.34315 3.34315 2 5 2H9V4H5C4.44772 4 4 4.44772 4 5V14H2V5Z",
                fill: "currentColor",
            }
            path {
                d: "M23 4.21387V10.5C23 11.8807 21.8807 13 20.5 13H18.5V8H15.5V13H13.5C12.1193 13 11 11.8807 11 10.5V4.21387L17 0.853516L23 4.21387Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
