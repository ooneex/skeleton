...
pub fn CartArrowDownIcon(props: CartArrowDownIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M26 2H23V8.99977L26 9V2Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M26 9V14H31.6215L24.5002 22.1213L17.3789 14H23V9H8.5L10.5 26H32.8553C35.6788 26 38.1794 24.1772 39.0434 21.4891L43.0578 9H26Z",
                fill: "currentColor",
            }
        }
    }
