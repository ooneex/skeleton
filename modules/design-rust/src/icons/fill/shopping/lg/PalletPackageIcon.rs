...
pub fn PalletPackageIcon(props: PalletPackageIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15 3H10V13.5H22V3H17V7H15V3Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M15 16.5H10V27L22 27V16.5H17V20.5H15V16.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M30.5 3H26V13.5H38V3H32.5V7H30.5V3Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M31 16.5H26V27H38V16.5H33V20.5H31V16.5Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
