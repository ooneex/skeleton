...
pub fn PalletPackageIcon(props: PalletPackageIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M20 3H17V9.00012H25V3H22V5H20V3Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M20 11.0001H17V16.9999L25 17V11.0001H22V13H20V11.0001Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M10 3H7V9.00012H15V3H12V5H10V3Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M10 11.0001H7V17L15 16.9999V11.0001H12V13H10V11.0001Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
