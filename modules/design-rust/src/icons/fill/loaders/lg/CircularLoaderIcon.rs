...
pub struct CircularLoaderIconProps {
    #[props(extends = svg, extends = GlobalAttributes)]
    pub attributes: Vec<Attribute>,
}

#[component]
pub fn CircularLoaderIcon(props: CircularLoaderIconProps) -> Element {
    rsx! {
        svg {
            height: "16",
            width: "16",
            ...
            path {
                d: "M24 2C36.1503 2 46 11.8497 46 24H43C43 13.5066 34.4934 5 24 5V2Z",
                fill: "currentColor",
            }
        }
    }
