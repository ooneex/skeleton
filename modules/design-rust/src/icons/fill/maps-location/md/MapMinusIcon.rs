    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M24 30.5C28.1421 30.5 31.5 27.1421 31.5 23C31.5 18.8579 28.1421 15.5 24 15.5C19.8579 15.5 16.5 18.8579 16.5 23C16.5 27.1421 19.8579 30.5 24 30.5ZM20 22V24H28V22H20Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
