...
pub fn SmokingBanIcon(props: SmokingBanIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M17 18.5H12L8.42871 13.5H17V18.5Z",
                fill: "currentColor",
            }
            path {
                d: "M15.6807 22.2324L14.0527 23.3945L3.60547 8.76758L5.23242 7.60547L15.6807 22.2324Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M8.09863 18.5H1V13.5H4.52734L8.09863 18.5Z",
                fill: "currentColor",
            }
        }
    }
