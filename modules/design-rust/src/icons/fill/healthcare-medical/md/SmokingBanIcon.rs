...
pub fn SmokingBanIcon(props: SmokingBanIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M19.3825 30.2959L17.7048 31.3828L4.30734 10.7041L5.98605 9.61719L19.3825 30.2959Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M18.3352 25H22V19H14.4478L18.3352 25Z",
                fill: "currentColor",
            }
            path {
                d: "M7.29864 19H2V25H11.186L7.29864 19Z",
                fill: "currentColor",
            }
        }
    }
