...
pub fn ChimneyIcon(props: ChimneyIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15 44H8V37H15V44Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M30 44H18V37H30V44Z",
                fill: "currentColor",
            }
            path {
                d: "M22.5 34H8V27H22.5V34Z",
                fill: "currentColor",
            }
            path {
                d: "M15 24H8V17H15V24Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M30 24H18V17H30V24Z",
                fill: "currentColor",
            }
            path {
                d: "M40 24H33V17H40V24Z",
                fill: "currentColor",
            }
            path {
                d: "M40 34H25.5V27H40V34Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
