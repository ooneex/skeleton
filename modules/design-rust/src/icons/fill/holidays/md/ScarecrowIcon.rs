...
pub fn ScarecrowIcon(props: ScarecrowIconProps) -> Element {
    rsx! {
        svg {
            ...
            ..props.attributes,
            path {
                d: "M12 6V9C12 11.209 13.791 13 16 13C18.209 13 20 11.209 20 9V6",
                fill: "currentColor",
            }
            path {
                d: "M15 27H17V32H15V27Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
                d: "M32 15V17H26V15H32Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
            ...
            path {
                d: "M20.3828 1L21.1328 7H10.8672L11.6172 1H20.3828Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
            path {
