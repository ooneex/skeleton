...
pub fn FirewallIcon(props: FirewallIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M21 44V32H4V38C4 41.3137 6.68629 44 10 44H21Z",
                fill: "currentColor",
            }
            path {
                d: "M32 17V4L38 4C41.3137 4 44 6.68629 44 10V17H32Z",
                fill: "currentColor",
            }
            path {
                d: "M16 17V4H10C6.68629 4 4 6.68629 4 10V17H16Z",
                fill: "currentColor",
            }
            path {
                d: "M4 29H12L12 20H4V29Z",
                fill: "currentColor",
            }
            path {
                d: "M21 20L15 20L15 29H21L21 20Z",
                fill: "currentColor",
            }
            path {
                d: "M29 17H19V4L29 4V17Z",
                fill: "currentColor",
            }
        }
    }
