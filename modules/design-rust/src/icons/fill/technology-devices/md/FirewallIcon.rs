...
pub fn FirewallIcon(props: FirewallIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M11 11V2H6C3.79086 2 2 3.79086 2 6V11H11Z",
                fill: "currentColor",
            }
            path {
                d: "M13 11H19V2H13V11Z",
                fill: "currentColor",
            }
            path {
                d: "M30 11V6C30 3.79086 28.2091 2 26 2H21V11H30Z",
                fill: "currentColor",
            }
            path {
                d: "M8.00003 13V19H2V13H8.00003Z",
                fill: "currentColor",
            }
            path {
                d: "M14 19L14 13H10V19H14Z",
                fill: "currentColor",
            }
            path {
                d: "M2 26V21H14L14 30H6C3.79086 30 2 28.2091 2 26Z",
                fill: "currentColor",
            }
        }
    }
