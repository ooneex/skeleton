...
pub fn WrenchScrewdriverIcon(props: WrenchScrewdriverIconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M20.0783 19.5951L4.15743 34.3363C1.35564 36.9301 1.27174 41.3314 3.97045 44.0302C6.66946 46.7292 11.0707 46.643 13.6642 43.8432L28.4052 27.9219C24.621 26.3997 21.6005 23.3793 20.0783 19.5951Z",
                fill: "currentColor",
            }
            path {
