    ...
    rsx! {
        svg {
            ...
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M1 9C1 6.79086 2.79086 5 5 5H27C29.2091 5 31 6.79086 31 9V11H29V9C29 7.89543 28.1046 7 27 7H5C3.89543 7 3 7.89543 3 9V19C3 20.1046 3.89543 21 5 21H15V23H5C2.79086 23 1 21.2091 1 19V9Z",
                fill: "currentColor",
            }
            path {
                fill_rule: "evenodd",
                clip_rule: "evenodd",
                d: "M25.8991 14.0908C27.2826 12.7073 29.5257 12.7073 30.9092 14.0908C32.2928 15.4743 32.2928 17.7174 30.9093 19.101L22.3785 27.6316L16.9033 28.0966L17.3683 22.6214L25.8991 14.0908Z",
                fill: "currentColor",
                "data-color": "color-2",
            }
        }
